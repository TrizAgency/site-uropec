    ...
    return (
        <main className="font-[family-name:var(--font-inter)] bg-[#f6f6f6]">
            ...
            <section className="container lg:py-20 py-10 flex flex-col lg:flex-row gap-5 lg:gap-20 items-center">
                <Image src="/produtos/duplo-j-com-fio-guia.jpg" alt="Duplo J com Fio Guia" width={450} height={450} className="rounded-[40px] " />

                <div className="text-blue flex flex-col gap-5 lg:w-1/2">
                    <h1 className="lg:text-3xl text-xl font-bold">Duplo J com Fio Guia</h1>
                    <p>O cateter ureteral duplo J proporciona maior comodidade para o paciente. Possui fio guia revestido de casta polimérica hidrofílica, o que oferece facilidade durante a realização do procedimento devido à redução do atrito entre o cateter e o guia.</p>
