    ...
    return (
        <main className="font-[family-name:var(--font-inter)] bg-[#f6f6f6]">
            ...
            <section className="container lg:py-20 py-10 flex flex-col lg:flex-row gap-5 lg:gap-20 items-center">
                <Image src="/produtos/sonda-zerotip.jpg" alt="Sonda Zerotip" width={450} height={450} className="rounded-[40px] " />

                <div className="text-blue flex flex-col gap-5 lg:w-1/2">
                    <h1 className="lg:text-3xl text-xl font-bold">Sonda Zerotip</h1>
                    <p>Cesto de Recuperação de Calculo Zero Tip, possui haste fina alojada numa bainha flexível com um cesto de 360° auto-expansível, sem ponta. O Cesto para Recuperação de Cálculos Zero Tip tem como finalidade ser utilizado durante procedimentos urológicos para segurar, manipular e remover endoscopicamente cálculos e outros objetos estranhos.</p>
