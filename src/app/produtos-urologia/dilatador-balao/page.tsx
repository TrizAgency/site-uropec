    ...
    return (
        <main className="font-[family-name:var(--font-inter)] bg-[#f6f6f6]">
            ...
            <section className="container lg:py-20 py-10 flex flex-col lg:flex-row gap-5 lg:gap-20 items-center">
                <Image src="/produtos/dilatador-balao.jpg" alt="Dilatador Balão" width={450} height={450} className="rounded-[40px] " />

                <div className="text-blue flex flex-col gap-5 lg:w-1/2">
                    <h1 className="lg:text-3xl text-xl font-bold">Dilatador Balão</h1>
                    <p>Indicado para a dilatação de segmentos estreitos na uretra, recomendado para dilatação transluminal de estreitamentos ureterais ou para dilatação antes de ureteroscopia ou manipulação de cálculo.</p>
