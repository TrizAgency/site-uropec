    ...
    return (
        <main className="font-[family-name:var(--font-inter)] bg-[#f6f6f6]">
            ...
            <section className="container lg:py-20 py-10 flex flex-col lg:flex-row gap-5 lg:gap-20 items-center">
                <Image src="/produtos/bainha-dilatadora-camisa-dilatadora.jpg" alt="Bainha Dilatadora / Camisa Dilatadora" width={450} height={450} className="rounded-[40px] " />

                <div className="text-blue flex flex-col gap-5 lg:w-1/2">
                    <h1 className="lg:text-3xl text-xl font-bold">Bainha Dilatadora / Camisa Dilatadora</h1>
                    <p>A Bainha Dilatadora é utilizada em procedimentos para dilatar o canal ureteral e assim facilitar a entrada/retirada do ureteroscópio flexível.</p>
