...
export default function Distributor() {
    return (
        <section className="lg:py-20 py-5" id="distribuidor" data-aos="fade-up">
            <Link href="#contato" className="container-lg lg:rounded-[88px] rounded-[38px] overflow-hidden relative lg:px-40 px-5 py-20 lg:pt-32 flex flex-col items-center justify-center lg:gap-8 gap-6 group">
