    ...
    return (
        <section className="py-10" id="areas-de-atuacao" >
            <div className="container flex flex-col lg:flex-row gap-7 lg:gap-10 items-center text-light-green lg:px-28">
                ...
                <div className="w-2/3 h-1 bg-[#3DCF84] mx-10 block lg:hidden" />
            ...
            <div className="container grid grid-cols-1 lg:grid-cols-3 gap-4 pt-12 lg:pt-20 pb-2">
                ...
                <div className="bg-white text-dark-green py-5 px-8 flex flex-col justify-between rounded-[38px]" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <Link href="/quem-somos" className="flex gap-6 justify-center items-center w-fit rounded-full bg-white text-dark-green hover:bg-dark-green hover:text-white border border-dark-green font-bold py-2 pl-4 pr-2 transition-all duration-300">
                        Saiba mais
                        <ArrowRight bgColor="#026E6A" arrowColor="#fff" />     
                    </Link>
                </div>

                <div className="bg-dark-green text-white py-5 px-8 flex flex-col justify-between rounded-[38px]" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <Link href="/quem-somos" className="flex gap-6 justify-center items-center w-fit rounded-full bg-dark-green text-white hover:bg-white hover:text-dark-green border border-white font-bold py-2 pl-4 pr-2 transition-all duration-300">
                        Saiba mais
            ...
            <div className="container flex flex-col-reverse lg:flex-row gap-2">
                <div className="bg-dark-green text-white py-5 px-8 gap-4 flex flex-col justify-between rounded-[38px]" data-aos="fade-right" data-aos-delay="400">
                ...
                <div className="bg-white text-dark-green py-5 px-8 flex flex-col justify-between rounded-[38px]" data-aos="fade-right" data-aos-delay="500">
                ...
                <Image src="/surgery.png" width={220} height={204} quality={100} alt="Cirurgia" className="hidden lg:block shrink-0" data-aos="fade-right" data-aos-delay="600" />
            </div>
        </section>
    )
}